...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if (_context.Department.Any() || _context.Seller.Any() || _context.Salesrecord.Any())   // Any() testa se existe algum registro na tabela Department,Seller e SalesRecord
            {
            ...
            //Adicionar ao banco todos os registros
